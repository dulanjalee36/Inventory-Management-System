...
def open_dashboard():
    ...
    root.geometry('1350x710+0+0')  # Adjusted height for consistency
    ...
    # ================= LEFT SIDE MENU (FIXED TOP ALIGNMENT) =================
    # y = header_height + subtitle_height (65 + 35 = 100)
    ...
    try:
        ...
        # bd=0 and highlightthickness=0 removes the white gap at the very top
    ...
    def create_menu_button(image_file, text, command):
        try:
            ...
            img = None
        # bd=1 and relief=GROOVE adds the lines between buttons seen in your image
        ...
        btn.image = img
        btn.pack(fill=tk.X, pady=0)  # pady=0 ensures buttons touch each other
